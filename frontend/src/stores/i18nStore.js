...
const translations = {
  he: {
    ...
    'download.activeTitle': 'הורדות בהתקדמות',
    'download.preparing': 'מכין הורדה...',
    'download.downloading': 'מוריד...',
    'download.saving': 'שומר במכשיר...',
    'download.completed': 'ההורדה הושלמה בהצלחה!',
    'download.failed': 'ההורדה נכשלה',
    'download.activeCount': 'שירים בהתקנה',
    ...
    'settings.importTitle': 'ייבוא פלייליסטים (Spotify & Apple Music)',
    'settings.importDesc': 'ייבא פלייליסטים, אלבומים ומוזיקה מחשבונות Spotify ו-Apple Music ישירות ל-Homeify בלחיצה אחת',
    'settings.importBtn': 'פתח מרכז ייבוא (Import Hub)',
  ...
  en: {
    ...
    'download.activeTitle': 'Active Downloads',
    'download.preparing': 'Preparing...',
    'download.downloading': 'Downloading...',
    'download.saving': 'Saving offline...',
    'download.completed': 'Download complete!',
    'download.failed': 'Download failed',
    'download.activeCount': 'songs downloading',
